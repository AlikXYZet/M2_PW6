...
int main()
{
	...
	std::cout << "Пример использования алгоритмов:\n"
		<< std::setw(14) << "1. Generate" << "для заполнения списка из 10 элементов целочисленными значениями;\n"
		<< std::setw(14) << "2. Transform" << "для целочисленного списка из 10 элементов;\n"
		<< std::setw(14) << "3. Remove" << "для фильтрации чисел больше 3 в целочисленном списке из 10 элементов.\n"
		<< '\n';
